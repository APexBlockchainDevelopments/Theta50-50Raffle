...
contract StealingHeartsRaffle is TNT721 {
    ...
    function changeMainURI(string memory _uri) public {
        require(msg.sender == admin, "You are not allowed to do that.");
        uri = _uri;
    }
    ...
    function changeExpirationDate(uint256 _expirationDate) public {
        require(msg.sender == admin, "You are not allowed to do that.");
    ...
    function setNFTURI(uint256 tokenMintIndex) public {
        require(msg.sender == admin, "You are not allowed to do that.");
        _setTokenURI(tokenMintIndex, uri);
    }
